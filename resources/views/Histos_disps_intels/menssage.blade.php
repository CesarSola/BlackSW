...
<head>
  ...
  <body>
    ...
    <nav role="navigation" class="navbar navbar-custom">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand">Invernadero</a>
          </div>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
          <div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
            	<ul class="list-group panel">
                	...
                	<li class="list-group-item"><a href="{{ url('Sensores')}}"><i class="glyphicon glyphicon-home"></i>Sensores </a></li>
          ...
          <div class="content-row" style="width: 300vw; display:flex;flex-grow:grow">
    ...
    <div class="container py-4">
        <h2>{{ $msg }}</h2>
        <a href="{{url('histos_disps_intels')}}" class="btn btn-secondary">Regresar</a>
    </div>
